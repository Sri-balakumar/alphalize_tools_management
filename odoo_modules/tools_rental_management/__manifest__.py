{
    ...
    'data': [
        ...
        'data/rental_expense_category_data.xml',
        'data/cron_data.xml',
        ...
        'wizard/rental_expense_split_wizard_views.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'tools_rental_management/static/src/js/rental_sales_report.js',
            'tools_rental_management/static/src/xml/rental_sales_report.xml',
